...
<head>
    ...
    <title><?= $title ? $title : 'Bienvenue' ?> | Error Page not found</title>
                ...
                <div class="col-sm-6">
                    <div class="float-left text-left">
                        ...
                        <img src="<?= base_url(); ?>global/img/logo/educaza100.png"
                            ...
                            | <a href="https://congoagile.com" style="background-color: transparent; color: blue; font-weight: bold;">My Application</a>
                        </span>
                    </div>
                </div>
                <div class="col-sm-6" >
