    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Enregistrement d'un nouveau Client</h3>
            </div>
          	...
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="phone_client" value="<?php echo $this->input->post('phone_client'); ?>" class="form-control" id="phone_client" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="email_client" value="<?php echo $this->input->post('email_client'); ?>" class="form-control" id="email_client" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="date_ajout" value="<?php echo $this->input->post('date_ajout'); ?>" class="has-datetimepicker form-control" id="date_ajout" />
						</div>
					</div>
				</div>
			</div>
